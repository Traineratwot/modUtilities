...
modUtilities.miniModX = class {
  ...
  constructor() {
    ...
    this.util.Exception = function Exception(message: string, code: number) {
...
modUtilities.miniUser = class {
   ...
   * @param {*} value
   */
  setSetting(key: string | number, value: any) {
    this.getSettings()
    // @ts-ignore
...
modUtilities.ConverterUnits = class {
  // @ts-ignore
  static converterRule = modUtilities.converterRule


  convert(n: number, type: string, from: string, to: string) {
  ...
  static ToSi(n: number, type: string, from: string) {
    if (typeof type == 'undefined') type = 'byte'
    if (typeof from == 'undefined') from = 'SI'
    // @ts-ignore
    if (typeof modUtilities.ConverterUnits.converterRule[type] != 'undefined') {
...
modUtilities.util = class {
  ...
  public convert: (n: any, type: any, from: any, to: any) => ({ "0": string; "1": any });
  public translitRule: any;
  public FirstLetter: number;
  public EveryWord: number;
  public AfterDot: number;
  public included: {} | any;
  public devMode: boolean|undefined;
   ...
   */
  // @ts-ignore
  mb_ucfirst(string = '', mode:number = modUtilities.FirstLetter, otherLower = true) {
      ...
      switch (mode) {
        case 3:
          ...
          for (var word of words) {
            word = word.trim()
            string = string.replace(word, <string>this.mb_ucfirst(word))
          }
          return string
        case 2:
  ...
  setCookie(name: string | number | boolean, value: string | number | boolean | null, options: any = {path: '/'}) {
    /*
    ...
    */
    ...
    let updatedCookie = encodeURIComponent(name) + '=' + encodeURIComponent(<string>value)
  ...
  deleteCookie(name: string | number | boolean) {
    /*
   ...
   * @param {boolean}     */
  include(source: string, name = false, parent_selector: string | boolean = false, async = true) {
   ...
   * @param {{}} value
   */
  setLocalStorage(name: string, value = {}) {
    name = name.toString()
